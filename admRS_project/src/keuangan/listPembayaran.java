...
public class listPembayaran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelHeader.setText("Daftar Pembayaran");
        ...
        btnStruck.setText("Tampilkan Struck");
        ...
        btnUpdStatsu.setText("Update Status Pembayaran");
    ...
    private void btnUpdStatsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdStatsuActionPerformed
        IDPembayaran start = new IDPembayaran();
        start.run();
        this.setVisible(false);
    ...
    public void run() {
                listPembayaran calcu = new listPembayaran();
